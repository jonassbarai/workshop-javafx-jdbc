...
public class SellerListController implements Initializable, DataChangeListener {
	...
	public void updateTableView() {
		...
		obsList = FXCollections.observableArrayList(list);
		tableViewSellers.setItems(obsList);
		//botões de edit e remove da grid
		initEditButtons();
		initRemoveButtons();
	}
	...
	private void createDialogForm(Seller obj, String absoluteName, Stage parentStage) {
		try {
			...
			controller.setSellerName(obj);
			controller.setSellerServices(new SellerService(), new DepartmentServices());
			...
			e.printStackTrace();
			Alerts.showAlert("IO Except", "Error loading view", e.getMessage(), AlertType.ERROR);
		}
	}
